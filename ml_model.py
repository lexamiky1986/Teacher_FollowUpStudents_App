...
def analizar_observacion(texto):
    """Analiza el texto y sugiere estrategias según contenido y tono."""
    sentimiento = TextBlob(texto).sentiment.polarity  # entre -1 y 1
    texto_lower = texto.lower()

    # --- Detección simple de patrones clave ---
